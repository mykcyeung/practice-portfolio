...
import { CanvasRevealEffect } from "./ui/CanvasRevealEffet";
    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        <Card
          ...
          description="This is where the magic happens! Based on the approved design, I'll tranlate everything into functional code, building your website from the ground up."
        >
          <CanvasRevealEffect
            animationSpeed={3}
